...
//urph-fin init
final urphFinInit = dl.lookupFunction<Bool Function(), bool Function()>('dart_urph_fin_core_init');

final register_init_callback = dl.lookupFunction<
...
void init_callback(Pointer<Void> p)
{
  print("urph-fin init done");
}
final initCallbackFP = Pointer.fromFunction<Void Function(Pointer<Void>)>(init_callback);
...
void setup_ffi()
{
  ...
  register_init_callback(nativePort, initCallbackFP);
  final initResult = urphFinInit();
